...
class RMSharedPreferences {
  static RMSharedPreferences? _singleton;
  static SharedPreferences? _store;

  static Future<RMSharedPreferences?> initialize() async {
    if (_singleton == null) {
      if (_singleton == null) {
        var singleton = RMSharedPreferences._();
